        ...
        <>
            <div className="homepage-container">
                ...
                <div className="intro">
                    ...
                    {/* <img className="delivery" src={deliverygif} alt=""></img> */}
                    <div className="svg-div">
                        <svg className="pattern" xmlns="http://www.w3.org/2000/svg" viewBox="350 0 1100 320">
                            ...
                            <path clip-path="url(#clipPath)" fill="#f0be49" fill-opacity="1" d="M0,256L60,234.7C120,213,240,171,360,176C480,181,600,235,720,261.3C840,288,960,288,1080,272C1200,256,1320,224,1380,208L1440,192L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z"></path>
                        </svg>
